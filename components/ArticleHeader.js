...
const ArticleHeader = ({ blok, full_slug }) => {
  ...
  return (
    <>
      <div className="article_header relative pt-5 pb-12 md:py-16 bg-gradient-to-r bg-slate-800" {...storyblokEditable(blok)}>
        <div className="w-full md:w-6/12 m-auto text-md md:text-lg px-7">
          <div className="pb-8">
            <ol
              className="flex items-center whitespace-nowrap min-w-0 text-gray-200"
